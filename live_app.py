...
with st.expander("How this works"):
    st.markdown("**Projected final** = points so far + (fraction of each starter's game still to play × his projection). "
                ...
                "this season and the week. A returner Sleeper doesn't project counts as 0 + his predicted return points. If Sleeper has no projection "
                "for any other starter (a doubtful role or injury), a starred name (*) means 'Sleeper + return points' assumes he is unavailable and "
