...
with st.expander("How this works"):
    st.markdown("**Projected final** = points so far + (fraction of each starter's game still to play × his projection). "
                ...
                "'Sleeper + return points' assumes he is unavailable and counts the team's best possible lineup without him (bench players can move in, "
                "and players can shift between slots such as FLEX / SUPER_FLEX; players whose games have started stay put). "
